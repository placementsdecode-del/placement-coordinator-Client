...
export type StudentGroup = { unreadCount?: number; kind?: "discussion" | "practice"; mode?: string; coordinators?: Peer[]; _id: string; name: string; description: string; createdBy: Peer | null; participants: { student: Peer | null; status: 'pending' | 'accepted' | 'declined' }[] };
